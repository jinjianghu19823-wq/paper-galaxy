(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "work.title": "Sources and jobs",
      "work.refresh": "Refresh",
      "work.sources": "Registered sources",
      "work.jobs": "Local jobs",
      "work.noSources": "No registered sources.",
      "work.noJobs": "No local jobs yet.",
      "work.rescan": "Rescan",
      "work.sync": "Sync",
      "work.cancel": "Cancel",
      "work.progress": "{current}/{total}",
      "work.failed": "Sources/jobs unavailable: {message}",
      "work.lastSuccess": "Last successful run: {time}",
      "work.noSuccessfulRun": "No successful run recorded yet.",
      "work.sourceError": "Source operation failed ({code}).",
      "work.jobError": "Local job failed ({code}).",
      "work.errorAction": "Inspect the local CLI for details, correct the issue, and retry.",
      "work.unknownTime": "unknown time",
      "work.job.queued": "Waiting for the local worker",
      "work.job.running": "Running locally",
      "work.job.cancelling": "Cancellation requested",
      "work.job.completed": "Completed",
      "work.job.failed": "Failed",
      "work.job.interrupted": "Interrupted; retry when ready",
      "work.job.cancelled": "Cancelled",
      "layout.title": "Layout",
    ...
    "zh-CN": {
      ...
      "work.sources": "已登记来源",
      "work.jobs": "本地任务",
      "work.noSources": "还没有登记来源。",
      "work.noJobs": "还没有本地任务。",
      "work.rescan": "重新扫描",
      "work.sync": "同步",
      "work.cancel": "取消",
      "work.progress": "{current}/{total}",
      "work.failed": "无法读取来源或任务：{message}",
      "work.lastSuccess": "最近成功运行：{time}",
      "work.noSuccessfulRun": "尚无成功运行记录。",
      "work.sourceError": "来源操作失败（{code}）。",
      "work.jobError": "本地任务失败（{code}）。",
      "work.errorAction": "请在本地 CLI 中查看详情，修正问题后重试。",
      "work.unknownTime": "时间未知",
      "work.job.queued": "正在等待本地工作线程",
      "work.job.running": "正在本机运行",
      "work.job.cancelling": "已请求取消",
      "work.job.completed": "已完成",
      "work.job.failed": "失败",
      "work.job.interrupted": "已中断，可在准备好后重试",
      "work.job.cancelled": "已取消",
      "layout.title": "布局",
